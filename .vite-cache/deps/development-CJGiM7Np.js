...
async function runBackground(router, tx, base, tasks, settlement) {
	...
	const projected = await projectLane$1(router, reduced, tx[0].signal);
...
var isServer = void 0;
//#endregion
export { redirect as $, interpolatePath as A, deepEqual as B, encode as C, storageKey as D, setupScrollRestoration as E, trimPathLeft as F, isDangerousProtocol as G, functionalUpdate as H, trimPathRight as I, isPlainObject as J, isModuleNotFoundError as K, DEFAULT_PROTOCOL_ALLOWLIST as L, removeTrailingSlash as M, resolvePath as N, cleanPath as O, trimPath as P, parseRedirect as Q, buildDevStylesUrl as R, decode as S, getElementScrollRestorationEntry as T, hasKeys as U, escapeHtml as V, hasOwn as W, isRedirect as X, replaceEqualDeep as Y, isResolvedRedirect as Z, executeRewriteInput as _, hydrate as a, parseSearchWith as b, SearchParamError as c, getLocationChangeInfo as d, rootRouteId as et, lazyFn as f, composeRewrites as g, createNonReactiveReadonlyStore as h, _getRenderedMatches as i, joinPaths as j, exactPathTest as k, defaultSerializeError as l, createNonReactiveMutableStore as m, loadServerRoute as n, notFound as nt, PathParamError as o, trailingSlashOptions as p, isPlainArray as q, _getAssetMatches as r, RouterCore as s, isServer as t, isNotFound as tt, getInitialRouterState as u, defaultParseSearch as v, defaultGetScrollRestorationKey as w, stringifySearchWith as x, defaultStringifySearch as y, createControlledPromise as z };
