...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DRoFS019.mjs");
...
var manifest = { "9f2bc4f468457a5ece8cfdf7a7dc28ee0bfbff709086b2588d2fbda778f1eb15": {
	functionName: "fetchBahamutLyrics_createServerFn_handler",
	importer: () => import("./fetch-B9DOgnH_.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CCNcsgsj.mjs").then((n) => n.t),
